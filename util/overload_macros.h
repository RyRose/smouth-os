...
// #define ADD_4(a, b, c, ...) (a) + (b) + (c) + add(__VA_ARGS__)
//
...
//
// #define ADD(...) UTIL_OVERLOAD_MACROS_VA_SELECT_4(ADD, __VA_ARGS__)
//
...
// ADD(1, 2, 3, 4, 5) -> ADD_4(1, 2, 3, 4, 5) -> (1) + (2) + (3) + add(4, 5)
//
// See
...
#define _UTIL_OVERLOAD_MACROS_VA_SIZE_2(...)                                   \
  _UTIL_OVERLOAD_MACROS_VA_COUNT(__VA_ARGS__, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, \
                                 2, 2, 2, 2, 2, 2, 2, 2, 1, 0)
...
#define _UTIL_OVERLOAD_MACROS_VA_SIZE_3(...)                                   \
  _UTIL_OVERLOAD_MACROS_VA_COUNT(__VA_ARGS__, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, \
                                 3, 3, 3, 3, 3, 3, 3, 2, 1, 0)
...
#define _UTIL_OVERLOAD_MACROS_VA_SIZE_4(...)                                   \
  _UTIL_OVERLOAD_MACROS_VA_COUNT(__VA_ARGS__, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, \
                                 4, 4, 4, 4, 4, 4, 3, 2, 1, 0)
#define UTIL_OVERLOAD_MACROS_VA_SELECT_4(name, ...)                          \
  _UTIL_OVERLOAD_MACROS_SELECT(name,                                         \
                               _UTIL_OVERLOAD_MACROS_VA_SIZE_4(__VA_ARGS__)) \
  (__VA_ARGS__)
