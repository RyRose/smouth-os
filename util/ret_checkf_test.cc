...
TEST(RetCheckF, Equals) {
  ...
  EXPECT_STREQ(
      "util/ret_checkf_test.cc:12: a (5) == b (10) not true: "
      "10, 20, 30, 40, 50",
      actual.Message());
}
...
TEST(RetCheckF, EqualsEmpty) {
  ...
  ASSERT_NOT_OK(actual);
  EXPECT_STREQ("util/ret_checkf_test.cc:47: a (5) == b (10) not true: INTERNAL",
               actual.Message());
}
...
TEST(RetCheckF, NotEquals) {
  ...
  ASSERT_NOT_OK(actual);
  EXPECT_STREQ(
      "util/ret_checkf_test.cc:17: a (10) != b (10) not true: "
      "10, 20, 30, 40, 50",
      actual.Message());
}
...
TEST(RetCheckF, NotEqualsEmpty) {
  ...
  ASSERT_NOT_OK(actual);
  EXPECT_STREQ(
      "util/ret_checkf_test.cc:52: a (10) != b (10) not true: INTERNAL",
      actual.Message());
}
...
TEST(RetCheckF, LessThan) {
  ...
  ASSERT_NOT_OK(actual);
  EXPECT_STREQ(
      "util/ret_checkf_test.cc:22: a (15) < b (10) not true: "
      "10, 20, 30, 40, 50",
      actual.Message());
}
...
TEST(RetCheckF, LessThanEmpty) {
  ...
  ASSERT_NOT_OK(actual);
  EXPECT_STREQ("util/ret_checkf_test.cc:57: a (15) < b (10) not true: INTERNAL",
               actual.Message());
}
...
TEST(RetCheckF, LessThanEquals) {
  ...
  ASSERT_NOT_OK(actual);
  EXPECT_STREQ(
      "util/ret_checkf_test.cc:27: a (15) <= b (10) not true: "
      "10, 20, 30, 40, 50",
      actual.Message());
}
...
TEST(RetCheckF, LessThanEqualsEmpty) {
  ...
  ASSERT_NOT_OK(actual);
  EXPECT_STREQ(
      "util/ret_checkf_test.cc:62: a (15) <= b (10) not true: "
      "INTERNAL",
      actual.Message());
}
...
TEST(RetCheckF, GreaterThan) {
  ...
  ASSERT_NOT_OK(actual);
  EXPECT_STREQ(
      "util/ret_checkf_test.cc:32: a (10) > b (15) not true: 10, "
      "20, 30, 40, 50",
      actual.Message());
}
...
TEST(RetCheckF, GreaterThanEmpty) {
  ...
  ASSERT_NOT_OK(actual);
  EXPECT_STREQ(
      "util/ret_checkf_test.cc:67: a (10) > b (15) not true: "
      "INTERNAL",
      actual.Message());
}
...
TEST(RetCheckF, GreaterThanEquals) {
  ...
  ASSERT_NOT_OK(actual);
  EXPECT_STREQ(
      "util/ret_checkf_test.cc:37: a (10) >= b (15) not true: "
      "10, 20, 30, 40, 50",
      actual.Message());
}
...
TEST(RetCheckF, GreaterThanEqualsEmpty) {
  ...
  ASSERT_NOT_OK(actual);
  EXPECT_STREQ(
      "util/ret_checkf_test.cc:72: a (10) >= b (15) not true: INTERNAL",
      actual.Message());
}
